...
class TarjetasSubcategoriasList extends StatefulWidget {
  ...
  const TarjetasSubcategoriasList({super.key, this.idCategoria, this.nombre});

  @override
  _TarjetasSubcategoriasListState createState() => _TarjetasSubcategoriasListState();
}

class _TarjetasSubcategoriasListState extends State<TarjetasSubcategoriasList> {
